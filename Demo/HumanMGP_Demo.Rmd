...
```{r}
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "min", sdy = 10, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=10, type = "max", sdy = 6, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "heatmap", sdy = 2, lambda =1e-8, ncores=10)
