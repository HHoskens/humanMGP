...
mgp.out = runHumanMGP(GOterm = GOterm, cohort = "TANZ", lm = "sparse", covs = c("age","sex"), window = 0, ncomp = 2, npc = 1, signif = F, nperm = 99, ncores = 10)
...
```{r}
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "min", sdy = 2, lambda = 5, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=10, type = "max", sdy = 6, lambda = 50, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=2, type = "heatmap", sdy = 6, lambda =1e-8, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=2, type = "overlay", sdy = 5, lambda = 1, ncores=10)
