...
mgp.out = runHumanMGP(GOterm = GOterm, cohort = "3DFN", lm = "sparse", covs = c("age","sex"), window = 0, ncomp = 2, npc = "all", signif = F, nperm = 99, ncores = 10)
...
```{r}
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "min", sdy = 3, lambda = 1e-8, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=10, type = "max", sdy = 6, lambda = 1e-8, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=c(1,2), type = "heatmap", sdy = 6, lambda =1e-8, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "overlay", sdy = 10, lambda = 1e-8, ncores=10)
...
mgp.geno = plotMGPLoadings(obj = mgp.out, comp = 1, type = "sum1"); mgp.geno
