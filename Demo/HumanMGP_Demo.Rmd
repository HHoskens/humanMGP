...
mgp.out = runHumanMGP(GOterm = GOterm, cohort = "3DFN", lm = "sparse", covs = c("age","sex"), window = 0, ncomp = 2, npc = 1, signif = F, nperm = 99, ncores = 10)

mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, sdy = 6, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "min", sdy = 6, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=10, type = "max", sdy = 6, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "heatmap", sdy = 6, lambda = 0, ncores=10)
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "overlay", sdy = 6, lambda = 0, ncores=10)
