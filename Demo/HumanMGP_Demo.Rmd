...
mgp.out = runHumanMGP(GOterm = GOterm, cohort = "TANZ", lm = "sparse", covs = c("age","age2","age3","sex","height","weight","csize"), window = 0, ncomp = 2, npc = "all", signif = T, nperm = 99, ncores = 10)
