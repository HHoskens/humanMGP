...
mgp.out = runHumanMGP(GOterm = GOterm, cohort = "TANZ", lm = "sparse", covs = c("age","sex","height","weight","csize"), window = 0, ncomp = 2, npc = 1, signif = F, nperm = 99, ncores = 10)
...
```{r}
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=2, type = "min", sdy = 10, lambda = 0, ncores=10)
...
mgp.pheno = plotMGPEffect(obj = mgp.out, comp=1, type = "overlay", sdy = 6, lambda = 1, ncores=10)
...
```{r}
mgp.geno = plotMGPLoadings(obj = mgp.out, comp = 2, type = "single"); mgp.geno
