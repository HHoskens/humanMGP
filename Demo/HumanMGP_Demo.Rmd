...
test = plotMGPEffect(obj = mgp.out, comp=2, sdy = 10, lambda = 0, ncores=10)

open3d(zoom = .65); 
plot3d(test$predmin, col = adjustcolor("darkgrey", .3), alpha = .9, specular = 1, axes = F, box = F, xlab = "", ylab = "", zlab = "", main = "", aspect = "iso", add = F)
